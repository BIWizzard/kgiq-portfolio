...
export default function Resume() {
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        ...
        // Use Supabase later when table is created
        setCertifications([
          {
            id: 1,
        ...
        // Process experience data - KEEP YOUR IMPROVED APPROACH
  ...
  return (
    <>
      <Navbar />
      <main className="min-h-screen px-6 py-10 text-white bg-fixed bg-cover bg-center pt-16"
